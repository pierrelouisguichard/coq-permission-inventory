    ...
    instance
      ...
      .then((response) => {
        Promise.all([
          ...
          .then(([graphDataResponse, groupSvcDataResponse]) => {
    ...
    <>
      <TabContainer>
        <Tab onClick={() => setSelectedTab(1)} active={selectedTab === 1}>
          Coquillade Permission Structuress
        </Tab>
